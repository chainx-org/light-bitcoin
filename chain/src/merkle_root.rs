...
mod tests {
    ...
    fn test_merkle_root_with_2_hashes() {
        let tx1 = h256("c06fbab289f723c6261d3030ddb6be121f7d2508d77862bb1e484f5cd7f92b25");
        let tx2 = h256("5a4ebf66822b0b2d56bd9dc64ece0bc38ee7844a23ff1d7320a88c5fdb2ad3e2");
        let expected = h256("8fb300e3fdb6f30a4c67233b997f99fdd518b968b9a3fd65857bfe78b2600719");
    ...
    fn test_merkle_root_with_3_hashes() {
        let txs = vec![
            h256("fd859b8a041591c4a759fc5e0a1eba3776739eef2066823a15fa3c2f2f0eb15e"),
            h256("10b6fe7a18750cd43c847ed1d82daf8f3ee19f885da2b770ecfa22e961a5b829"),
            h256("73496b488e2fccace327a81c6887ca08c3551c42f9adfe3984104390859bd794"),
        ];
        let expected = h256("876ec557b3686aec47a98587420373a29f36c1fbc119a7bc6807163164a5fb8a");

        let result = merkle_root(&txs);
        assert_eq!(result, expected);
    }
}
