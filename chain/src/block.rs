...
mod tests {
    ...
    fn test_block_merkle_root_and_hash() {
        ...
        let merkle_root = h256("8fb300e3fdb6f30a4c67233b997f99fdd518b968b9a3fd65857bfe78b2600719");
        assert_eq!(block.merkle_root(), merkle_root);
        let hash = h256("000000000043a8c0fd1d6f726790caa2a406010d19efd2780db27bdbbd93baf6");
